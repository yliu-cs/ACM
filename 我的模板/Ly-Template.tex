...
\subsection{vim}
\inputminted[breaklines]{c++}{其他/vim.vim}
...
\section{Yiguang Li}
\subsection{匈牙利算法}
\inputminted[breaklines]{c++}{Li/匈牙利算法.cpp}
\subsection{KM算法求最佳匹配}
\inputminted[breaklines]{c++}{Li/KM.cpp}
\subsection{HK算法求最大匹配}
\inputminted[breaklines]{c++}{Li/HK.cpp}
\subsection{Tarjan求连通分量}
\inputminted[breaklines]{c++}{Li/Tarjan求连通分量.cpp}
\subsection{Tarjan求割点和桥}
\inputminted[breaklines]{c++}{Li/Tarjan求割点和桥.cpp}
\subsection{字符串最大最小表示法}
\inputminted[breaklines]{c++}{Li/字符串最大最小表示法.cpp}
\subsection{扩展KMP}
